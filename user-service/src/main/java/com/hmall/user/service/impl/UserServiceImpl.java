...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements IUserService {
    //PasswordEncoder接口是Spring框架中的一个核心接口，用于将密码进行加密和验证，它定义了俩个方法: encode()和matches()
    //encode方法接受一个明文密码作为输入，并返回加密后的密码
    //matches方法用于验证一个明文密码是否与已加密的密码匹配，它接受俩个参数：明文密码和已加密的密码
